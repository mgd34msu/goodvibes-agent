...
describe('release metadata', () => {
  ...
  test('documents release checklist and manual PTY gate', async () => {
    ...
    expect(changelog).toContain('@pellux/goodvibes-sdk@0.33.31');
    ...
    expect(upgrade).toContain('@pellux/goodvibes-sdk@0.33.31');
    ...
    expect(risks).toContain('SDK `0.33.31` Agent knowledge validation');
