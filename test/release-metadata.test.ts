...
describe('release metadata', () => {
  ...
  test('documents release checklist and manual PTY gate', async () => {
    ...
    expect(changelog).toContain('@pellux/goodvibes-sdk@0.33.32');
    ...
    expect(upgrade).toContain('@pellux/goodvibes-sdk@0.33.32');
    ...
    expect(risks).toContain('SDK `0.33.32` Agent knowledge validation');
