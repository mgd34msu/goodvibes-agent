...
const HARNESS_CHANNEL_READINESS_MODES = ['channels', 'channel'] as const;
...
const HARNESS_SETUP_POSTURE_MODES = ['setup_posture', 'setup_item', 'provision_connected_host_token', 'run_setup_smoke'] as const;
