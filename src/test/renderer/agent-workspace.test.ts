...
describe('renderAgentWorkspace', () => {
  ...
  test('renders Research with source report artifacts and a confirmed save form', () => {
    ...
    expect(output).toContain('Model route: research action:"plan|runs|sources|report".');
  ...
  test('renders voice media and browser tool setup posture', () => {
    ...
    try {
      ...
      expect(output).toContain('Model route: device action:"voice|status"; computer action:"browser|open_browser".');
