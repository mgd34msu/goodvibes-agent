  ...
  return {
    ...
    lanes: [
      lane({
        ...
        routes: [
          'agent_harness mode:"setup_posture"',
          'agent_harness mode:"setup_item"',
          'agent_harness mode:"setup_checkpoint"',
          'agent_harness mode:"mark_setup_checkpoint"',
          'agent_harness mode:"clear_setup_checkpoint"',
          'agent_harness mode:"provision_connected_host_token"',
          'agent_harness mode:"run_setup_smoke"',
        ],
      }),
      lane({
        id: 'chat-and-model',
