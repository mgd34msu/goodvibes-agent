...
export const COMPETITIVE_FEATURE_INVENTORY: readonly CompetitiveFeatureInventoryItem[] = [
  ...
  },
  {
    ...
    nextMoves: [
      ...
      'Add per-receipt Local Context drill-in and filtering for long prompt receipt histories while keeping raw prompt and response bodies out of the UI.',
