...
export const COMPETITIVE_FEATURE_INVENTORY: readonly CompetitiveFeatureInventoryItem[] = [
  ...
  },
  {
    ...
    nextMoves: [
      ...
      'Attach durable per-turn prompt-context receipt ids once the prompt composer publishes exact selected-record snapshots for completed turns.',
