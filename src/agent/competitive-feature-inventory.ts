...
export const COMPETITIVE_FEATURE_INVENTORY: readonly CompetitiveFeatureInventoryItem[] = [
  ...
  },
  {
    ...
    nextMoves: [
      ...
      'Attach runtime prompt-selection and token-budget evidence to the prompt plan once the prompt composer exposes exact selected records.',
