...
export const COMPETITIVE_FEATURE_INVENTORY: readonly CompetitiveFeatureInventoryItem[] = [
  ...
  },
  {
    ...
    goodVibesStatus: 'partial',
    owners: ['agent', 'connected-host'],
    goodVibesNow: 'Agent has web research, URL inspection, Agent Knowledge, and ingest routes, but not a best-in-class deep research report workflow.',
    nextMoves: [
      'Add a deep research mode with plan, source queue, credibility scoring, report drafting, and explicit knowledge ingest.',
      'Render reports as artifacts with citation maps and reusable source bundles.',
  ...
  },
  {
    ...
    goodVibesStatus: 'partial',
    owners: ['agent', 'connected-host'],
    goodVibesNow: 'Document Ops now has project-scoped versioned markdown drafts with browse/show/create/revise/review/comment/suggest/accept-suggestion/reject-suggestion/artifact-insert/export, uploads, exports, sources, media artifacts, a unified artifact browser with read-only browse/show, filters, redacted metadata, bounded text previews, confirmed artifact-to-Knowledge promotion, and confirmed artifact-to-compare reuse for saved text artifacts, plus a confirmed blind comparison runner with delayed reveal, durable JSON comparison artifacts, saved review boards, saved judgment artifacts, saved preference analytics, markdown report export, and confirmed winner route updates. Richer attach/export reuse actions remain unfinished.',
    nextMoves: [
      'Add reuse actions that attach or export selected uploads, generated media, documents, session exports, delegation outputs, and knowledge sources from the artifact browser.',
