...
export const COMPETITIVE_FEATURE_INVENTORY: readonly CompetitiveFeatureInventoryItem[] = [
  ...
  },
  {
    ...
    nextMoves: [
      ...
      'Surface prompt-context receipt outcome history in a dedicated workspace timeline instead of requiring the user to inspect the harness JSON.',
