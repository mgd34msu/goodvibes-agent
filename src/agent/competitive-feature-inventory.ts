...
export const COMPETITIVE_FEATURE_INVENTORY: readonly CompetitiveFeatureInventoryItem[] = [
  ...
  },
  {
    ...
    nextMoves: [
      'Tighten the visible setup flow so host install/start, token provisioning, model choice, and first assistant turn feel like one checklist instead of separate handoff cards.',
