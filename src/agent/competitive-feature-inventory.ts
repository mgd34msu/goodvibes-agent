...
export const COMPETITIVE_FEATURE_INVENTORY: readonly CompetitiveFeatureInventoryItem[] = [
  ...
  },
  {
    ...
    nextMoves: [
      ...
      'Certify watcher creation/execution outcomes and provider-specific Gmail/email source records beyond the current published watcher contract.',
    ],
    competitorSignals: [
