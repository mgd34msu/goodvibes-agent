...
export type GoodVibesCompetitiveStatus = 'leading' | 'parity' | 'handoff' | 'partial' | 'gap';
...
export interface CompetitiveFeatureInventoryItem {
  ...
  readonly handoffDocs?: readonly string[];
  readonly competitorSignals: readonly CompetitorFeatureSignal[];
}

const TUI_DAEMON_HANDOFF = 'docs/audits/goodvibes-tui-handoff.md';
const SDK_HANDOFF = 'docs/audits/goodvibes-sdk-handoff.md';
...
export const COMPETITIVE_FEATURE_INVENTORY: readonly CompetitiveFeatureInventoryItem[] = [
  ...
  },
  {
    ...
    handoffDocs: [TUI_DAEMON_HANDOFF, SDK_HANDOFF],
    competitorSignals: [
