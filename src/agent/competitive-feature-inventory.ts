...
export const COMPETITIVE_FEATURE_INVENTORY: readonly CompetitiveFeatureInventoryItem[] = [
  ...
  },
  {
    ...
    nextMoves: [
      ...
      'Link prompt-context receipts to terminal turn outcomes and UI timelines so users can inspect what context was active when a turn succeeded, failed, or was cancelled.',
