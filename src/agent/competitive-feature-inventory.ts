...
export const COMPETITIVE_FEATURE_INVENTORY: readonly CompetitiveFeatureInventoryItem[] = [
  ...
  },
  {
    ...
    nextMoves: [
      ...
      'Add explicit user-facing background process controls for start/list/poll/wait/log/kill/write and PTY mode when the local execution policy allows it.',
      'Expose sudo setup posture and SUDO_PASSWORD guidance without ever storing or printing raw password values.',
