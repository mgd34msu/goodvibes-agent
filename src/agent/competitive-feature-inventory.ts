...
export const COMPETITIVE_FEATURE_INVENTORY: readonly CompetitiveFeatureInventoryItem[] = [
  ...
  },
  {
    ...
    nextMoves: [
      ...
      'Expose refreshed-preset lineage in the review packet wizard final step so users can verify which stale preset was repaired before sharing the archive.',
    ],
    competitorSignals: [
