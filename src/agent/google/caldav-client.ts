...
import { isCalendarResourceType, parseCalendarDataEvents, parseMultistatus, type CalDavEventRecord } from './caldav-parse.ts';
...
/** The only place this module performs real network I/O: a thin wrapper over the global `fetch`. */
