/**
 * The one tar reader in this repo.
 *
 * Two things need to read a gzipped tar without spawning `tar`: the update path
 * (pull one addon file out of a release archive) and browser driver
 * provisioning (write a whole package tree to disk). Both are release-critical
