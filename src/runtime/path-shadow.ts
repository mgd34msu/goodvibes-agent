 ...
 * policy lives because more than one surface needs it (this agent, the TUI,
 ...
 * src/test/runtime/path-shadow.test.ts keep working unchanged. The same copy
 * lives in goodvibes-tui; keep the two identical until both re-export.
 *
