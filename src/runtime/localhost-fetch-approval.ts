 ...
 *
 * Vendored mirror of the SDK's platform/runtime/permissions/
 * localhost-fetch-approval.ts (no public export path); the Agent forks the
 * SDK's runtime composition root and must wire the same approval flow.
 *
