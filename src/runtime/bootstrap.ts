...
const GOODVIBES_AGENT_OPERATOR_POLICY = [
  ...
  '- Confirmed tools: use `agent_operator_action`, `agent_artifacts` export/package, `agent_documents`, `agent_knowledge_ingest`, `agent_media_generate`, `agent_model_compare`, `agent_notify`, `agent_channel_send`, and `agent_reminder_schedule` only for explicit user requests with confirm:true and explicitUserRequest.',
