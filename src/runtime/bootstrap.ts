...
const GOODVIBES_AGENT_OPERATOR_POLICY = [
  ...
  '- When the user explicitly asks Agent to add, import, remember, or ingest a URL into its wiki/knowledge, use the `agent_knowledge_ingest` tool with confirm:true and the original user request. It must write only to /api/goodvibes-agent/knowledge/ingest/url and never to default Knowledge/Wiki or HomeGraph.',
