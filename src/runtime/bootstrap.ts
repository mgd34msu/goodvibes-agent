...
const GOODVIBES_AGENT_OPERATOR_POLICY = [
  ...
  '- Confirmed tools: use `agent_operator_action`, `agent_artifacts` export/package, `agent_documents`, `agent_knowledge_ingest`, `agent_media_generate`, `agent_model_compare`, `agent_research_runs`, `agent_research_sources`, `agent_research_report`, `agent_notify`, `agent_channel_send`, `agent_autonomy_schedule`, and `agent_reminder_schedule` only for explicit user requests with confirm:true and explicitUserRequest.',
