...
function snapshotLines(workspace: AgentWorkspace, category: AgentWorkspaceCategory, snapshot: AgentWorkspaceRuntimeSnapshot | null): ContextLine[] {
  ...
  if (category.id === 'home') {
    ...
    base.push(
      ...
      { text: 'Saved compare review/judgment, export, and route update are available; document editor/history and unified artifact browser remain gaps.', fg: PALETTE.warn },
