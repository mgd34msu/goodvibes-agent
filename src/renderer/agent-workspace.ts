...
function snapshotLines(workspace: AgentWorkspace, category: AgentWorkspaceCategory, snapshot: AgentWorkspaceRuntimeSnapshot | null): ContextLine[] {
  ...
  if (category.id === 'home') {
    ...
    base.push(
      ...
      { text: 'Model route: research action:"plan|search|runner|runs|sources|reports|report".', fg: PALETTE.good },
    );
    ...
    base.push(
      ...
      { text: 'Model route: device action:"voice|status"; computer action:"browser|open_browser".', fg: PALETTE.info },
