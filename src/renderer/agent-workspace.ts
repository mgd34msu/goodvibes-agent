...
function snapshotLines(workspace: AgentWorkspace, category: AgentWorkspaceCategory, snapshot: AgentWorkspaceRuntimeSnapshot | null): ContextLine[] {
  ...
  if (category.id === 'home') {
    ...
    base.push(
      ...
      { text: 'Versioned drafts, review comments, AI suggestion review, artifact insertion, artifact browser, Knowledge promotion, compare review/judgment, analytics, export, and route update are available.', fg: PALETTE.good },
      { text: 'Richer attach/export/compare artifact reuse remains a gap.', fg: PALETTE.warn },
