    ...
    switch (sub) {
      ...
      default: {
        const usage = [
          ...
          '  review <id> <state> [--confidence <n>] [--by <name>] [--reason <text>] --yes',
          '  stale <id> [reason...] --yes                    — Mark a record stale with an operator reason',
          '  contradict <id> [reason...] --yes               — Mark a record contradicted with an operator reason',
