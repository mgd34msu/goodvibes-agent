  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        hint: 'Messages sent here attach to the active Agent terminal session and reply back to ntfy.',
      ...
      },
      {
        ...
        hint: 'Messages sent here start Agent work attached to the active terminal session.',
      ...
      },
      {
        ...
        hint: 'Messages sent here start an ntfy remote session in the external daemon and do not appear in the Agent terminal session.',
