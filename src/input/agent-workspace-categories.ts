...
export const AGENT_WORKSPACE_CATEGORIES: readonly AgentWorkspaceCategory[] = [
  ...
  },
  {
    ...
    actions: [
      ...
      { id: 'account-local-server-health', label: 'Check local servers', detail: 'Run a confirmed read-only model-list smoke check for detected or default local endpoints before refresh, benchmark, provider add, or route change.', kind: 'guidance', safety: 'read-only' },
