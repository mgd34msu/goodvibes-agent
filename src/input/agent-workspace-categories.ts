...
export const AGENT_WORKSPACE_CATEGORIES: readonly AgentWorkspaceCategory[] = [
  {
    ...
    actions: [
      ...
      { id: 'personal-ops-home', label: 'Personal operations', detail: 'Jump to inbox, agenda, notes, tasks, reminders, routines, and delivery readiness from one daily operations area.', targetCategoryId: 'personal-ops', kind: 'workspace', safety: 'safe' },
  ...
  },
  {
    ...
    actions: [
      ...
      { id: 'account-local-model-cookbook', label: 'Local model cookbook', detail: 'Review local model recommendations and open the shared provider/model picker for the main chat route.', kind: 'model-picker', modelPickerFlow: 'providerModel', modelPickerTarget: 'main', safety: 'safe' },
  ...
  },
  {
    ...
    group: 'DAY-TO-DAY',
    label: 'Research',
    summary: 'Read-only web research, source triage, and report artifacts.',
    detail: 'Use this workspace to ask Agent to search, inspect URLs, compare sources, save sourced report artifacts, and decide what belongs in isolated Agent Knowledge. Research requests run in the normal conversation; source ingestion is explicit.',
    actions: [
  ...
  },
  {
    ...
    actions: [
      ...
      { id: 'document-export-artifact-package', label: 'Export artifact package', detail: 'Open a confirmed form that copies selected saved artifacts into a workspace package directory with a redacted manifest.', editorKind: 'artifact-export-package', kind: 'editor', safety: 'safe' },
      ...
      { id: 'document-compare-analytics', label: 'Compare analytics', detail: 'Summarize saved comparison judgments by winner, model, blind slot, and recent reasons.', editorKind: 'model-compare-analytics', kind: 'editor', safety: 'read-only' },
      ...
      { id: 'document-export-compare', label: 'Export compare report', detail: 'Open a confirmed form that exports a saved comparison or judgment artifact as markdown.', editorKind: 'model-compare-export', kind: 'editor', safety: 'safe' },
    ],
  },
  {
    id: 'artifacts',
    ...
    actions: [
      ...
      { id: 'artifact-export-package', label: 'Export package', detail: 'Open a confirmed form that copies selected saved artifacts into a workspace package directory with a redacted manifest.', editorKind: 'artifact-export-package', kind: 'editor', safety: 'safe' },
      ...
      { id: 'artifact-compare-analytics', label: 'Compare analytics', detail: 'Summarize saved comparison judgment artifacts by winner, model, blind slot, and recent reasons.', editorKind: 'model-compare-analytics', kind: 'editor', safety: 'read-only' },
      ...
      { id: 'artifact-export-compare', label: 'Export compare report', detail: 'Open a confirmed form that exports a saved comparison or judgment artifact as markdown.', editorKind: 'model-compare-export', kind: 'editor', safety: 'safe' },
  ...
  },
  {
    ...
    actions: [
      ...
      { id: 'memory-learning-curator', label: 'Learning curator', detail: 'Inspect ranked local memory, note, persona, skill, bundle, and routine candidates with review, setup, stale, and capture routes.', kind: 'guidance', safety: 'read-only' },
