...
export const AGENT_WORKSPACE_CATEGORIES: readonly AgentWorkspaceCategory[] = [
  ...
  },
  {
    ...
    detail: 'Use this workspace when the user is producing or evaluating a document. Versioned drafts, artifact insertion/export, upload, source, artifact browsing, media, and blind comparison routes stay visible here; comments and AI suggestion review remain explicit next steps.',
    actions: [
