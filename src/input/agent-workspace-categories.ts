...
export const AGENT_WORKSPACE_CATEGORIES: readonly AgentWorkspaceCategory[] = [
  ...
  },
  {
    ...
    detail: 'Use this workspace when the user is producing or evaluating a document. Upload, export, source, artifact, media, and blind comparison routes stay visible here; dedicated document editing and unified artifact browsing remain explicit gaps until implemented.',
    actions: [
