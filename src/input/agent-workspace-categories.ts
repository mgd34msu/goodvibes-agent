...
export const AGENT_WORKSPACE_CATEGORIES: readonly AgentWorkspaceCategory[] = [
  ...
  ...AGENT_WORKSPACE_ONBOARDING_DETAIL_CATEGORIES,
  {
    ...
    actions: [
      ...
      { id: 'personal-ops-google-status', label: 'Google connection status', detail: 'What Gmail and Calendar have configured, and — separately — whether Google credentials already exist on this machine that nothing is using yet. Reads only; no credential is shown.', editorKind: 'google-status', kind: 'editor', safety: 'read-only' },
