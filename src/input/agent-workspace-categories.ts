...
export const AGENT_WORKSPACE_CATEGORIES: readonly AgentWorkspaceCategory[] = [
  ...
  },
  {
    ...
    actions: [
      ...
      { id: 'document-review-compare', label: 'Review saved compare', detail: 'Open a read-only form that lists saved blind comparisons, renders one review board, or shows related artifacts beside comparison evidence.', editorKind: 'model-compare-review', kind: 'editor', safety: 'read-only' },
      ...
      { id: 'document-compare-analytics', label: 'Compare analytics', detail: 'Summarize or synthesize saved comparison judgments by winner, model, blind slot, themes, and recent reasons.', editorKind: 'model-compare-analytics', kind: 'editor', safety: 'read-only' },
      ...
      { id: 'document-export-compare', label: 'Export compare report', detail: 'Open a confirmed form that exports a saved comparison or judgment report, or creates a reviewer handoff with related artifacts.', editorKind: 'model-compare-export', kind: 'editor', safety: 'safe' },
    ],
  },
  {
    id: 'artifacts',
    ...
    actions: [
      ...
      { id: 'artifact-review-compare', label: 'Review blind compare', detail: 'Open a read-only saved comparison review form or side-by-side evidence view for model comparison artifacts.', editorKind: 'model-compare-review', kind: 'editor', safety: 'read-only' },
      ...
      { id: 'artifact-compare-analytics', label: 'Compare analytics', detail: 'Summarize or synthesize saved comparison judgment artifacts by winner, model, blind slot, themes, and recent reasons.', editorKind: 'model-compare-analytics', kind: 'editor', safety: 'read-only' },
      ...
      { id: 'artifact-export-compare', label: 'Export compare report', detail: 'Open a confirmed form that exports a saved comparison or judgment report, or creates a reviewer handoff with related artifacts.', editorKind: 'model-compare-export', kind: 'editor', safety: 'safe' },
