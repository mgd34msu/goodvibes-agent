...
export const AGENT_WORKSPACE_CATEGORIES: readonly AgentWorkspaceCategory[] = [
  ...
  },
  {
    ...
    actions: [
      ...
      { id: 'account-route-readiness', label: 'Inspect route readiness', detail: 'Review chat, helper, tool, and spoken-turn routes with readiness scores, missing signals, pinned state, and safe setting keys without changing selection.', kind: 'guidance', safety: 'read-only' },
      ...
      { id: 'account-local-server-health', label: 'Check local servers', detail: 'Inspect detected local endpoint candidates, model-list smoke commands, refresh routes, provider-add routes, and setup gaps before any benchmark or route change.', kind: 'guidance', safety: 'read-only' },
      ...
      { id: 'account-local-benchmark-evidence', label: 'Review benchmark evidence', detail: 'Inspect saved local model comparisons, revealed judgments, analytics routes, and next actions before any default-route change.', kind: 'guidance', safety: 'read-only' },
  ...
  },
  {
    ...
    actions: [
      ...
      { id: 'research-workflow-plan', label: 'Plan workflow', detail: 'Inspect one ordered read-only plan across visible run state, browser-runner readiness, source review, report save, visual-report readiness, and Knowledge promotion with agent_harness mode:"research_workflow".', kind: 'guidance', safety: 'read-only' },
  ...
  },
  {
    ...
    actions: [
      { id: 'voice-workflow-posture', label: 'Voice workflows', detail: 'Inspect push-to-talk, voice memo transcription, spoken responses, and wake-word readiness with honest setup/not-published states.', kind: 'guidance', safety: 'read-only' },
      { id: 'device-capability-map', label: 'Device capability map', detail: 'Inspect pairing, mobile command routing, browser/PWA, notifications, browser/desktop control, and camera/location readiness without claiming unpublished contracts.', kind: 'guidance', safety: 'read-only' },
      { id: 'browser-cockpit-readiness', label: 'Browser/PWA readiness', detail: 'Inspect the connected browser cockpit/PWA route, workspace category coverage, mobile controls, and first-run receipt gaps before opening a browser.', kind: 'guidance', safety: 'read-only' },
