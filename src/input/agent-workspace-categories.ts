...
export const AGENT_WORKSPACE_CATEGORIES: readonly AgentWorkspaceCategory[] = [
  ...
  },
  {
    ...
    detail: 'Use this workspace when the user is producing or evaluating a document. Upload, export, source, artifact browsing, media, and blind comparison routes stay visible here; dedicated document editing remains an explicit gap until implemented.',
    actions: [
