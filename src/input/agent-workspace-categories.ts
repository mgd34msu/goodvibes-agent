...
export const AGENT_WORKSPACE_CATEGORIES: readonly AgentWorkspaceCategory[] = [
  ...
  ...AGENT_WORKSPACE_ONBOARDING_DETAIL_CATEGORIES,
  {
    ...
    actions: [
      ...
      { id: 'personal-ops-calendar', label: 'Calendar workflows', detail: 'No external calendar account is connected in this build (no CalDAV/Google/Outlook sync). Add events to the local Agent calendar here.', editorKind: 'calendar-connect', kind: 'editor', safety: 'safe' },
