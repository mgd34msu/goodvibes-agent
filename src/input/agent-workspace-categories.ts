...
export const AGENT_WORKSPACE_CATEGORIES: readonly AgentWorkspaceCategory[] = [
  ...
  },
  {
    ...
    actions: [
      ...
      { id: 'memory-learning-curator', label: 'Learning curator', detail: 'Inspect ranked local memory, note, persona, skill, bundle, and routine candidates with review, setup, stale, proposal, and capture routes.', kind: 'guidance', safety: 'read-only' },
