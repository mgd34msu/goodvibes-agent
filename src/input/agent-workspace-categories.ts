...
export const AGENT_WORKSPACE_CATEGORIES: readonly AgentWorkspaceCategory[] = [
  ...
  },
  {
    ...
    actions: [
      ...
      { id: 'conversation-sessions', label: 'Browse saved sessions', detail: 'Browse saved Agent sessions from the TUI without using a shell-only command.', command: '/sessions', kind: 'command', safety: 'read-only' },
