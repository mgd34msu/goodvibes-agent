...
export const AGENT_WORKSPACE_CATEGORIES: readonly AgentWorkspaceCategory[] = [
  ...
  },
  {
    ...
    actions: [
      ...
      { id: 'research-save-report', label: 'Save research report', detail: 'Open a confirmed form that saves a reviewed source-grounded markdown report as an Agent artifact with a source map.', editorKind: 'research-report', kind: 'editor', safety: 'safe' },
