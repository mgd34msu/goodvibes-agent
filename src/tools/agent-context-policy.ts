...
function buildAgentCapabilitiesContract(registry?: ToolRegistry): Record<string, unknown> {
  ...
  return {
    ...
    commonRoutes: {
      ...
      artifacts: 'agent_artifacts mode:"list"; inspect with mode:"show"; export with mode:"export"; promote reviewed artifact ids with agent_knowledge_ingest sourceKind:"artifact"',
