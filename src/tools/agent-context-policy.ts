  ...
  return {
    ...
    canDoNow: [
      ...
      },
      {
        ...
        can: 'Create, revise, version, review, and export Agent document drafts; browse saved artifacts; promote reviewed artifacts into isolated Agent Knowledge; handle uploads, source checks, generated media artifacts, and run confirmed blind model comparisons with durable review, judgment, and route-update actions.',
    ...
    commonRoutes: {
      ...
      documents: 'agent_documents mode:"list"; show with documentId; confirmed create/update/review/export with confirm:true',
