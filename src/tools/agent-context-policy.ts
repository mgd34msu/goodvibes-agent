...
function buildAgentCapabilitiesContract(registry?: ToolRegistry): Record<string, unknown> {
  ...
  return {
    ...
    commonRoutes: {
      ...
      personalOps: 'agent_harness mode:"personal_ops_intake" query:"<personal request>"; agent_harness mode:"personal_ops"; inspect one lane with mode:"personal_ops_lane"',
