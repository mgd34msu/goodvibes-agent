  ...
  return {
    ...
    canDoNow: [
      ...
      },
      {
        ...
        can: 'Inspect provider accounts, subscriptions, model routing, hardware-scored local model cookbook, setup posture, service posture, and connected-host status; apply supported settings changes when explicitly requested.',
