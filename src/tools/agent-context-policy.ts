  ...
  return {
    ...
    canDoNow: [
      ...
      },
      {
        ...
        inspect: 'research action:"plan" query:"<research request>", action:"search" for public source candidates, or action:"runner" for browser-backed readiness',
      },
      {
    ...
    commonRoutes: {
      ...
      researchWorkflow: 'research action:"plan" query:"<research request>"; returns visible-run, source, report, browser/fetch, and Knowledge routes without running them; use action:"search" for bounded public source candidates and action:"runner" for browser-backed readiness only',
