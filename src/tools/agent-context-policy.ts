...
function buildAgentCapabilitiesContract(registry?: ToolRegistry): Record<string, unknown> {
  ...
  return {
    ...
    commonRoutes: {
      ...
      reviewPacketPresets: 'agent_review_packet_presets mode:"list"; show with artifactId to check missing/superseded ids and recommended reuse routes; save reusable packet defaults with mode:"save" confirm:true explicitUserRequest:"..."',
