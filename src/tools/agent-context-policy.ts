  ...
  return {
    ...
    canDoNow: [
      ...
      },
      {
        ...
        inspect: 'research action:"plan" query:"<research request>" or action:"runner" for browser-backed readiness',
      },
      {
    ...
    commonRoutes: {
      ...
      computer: 'computer action:"status|control|browser|setup|mcp"; open the connected browser cockpit with action:"open_browser" confirm:true explicitUserRequest:"..."; use this route for browser/PWA, desktop-control, screen, and computer-use posture',
      ...
      researchWorkflow: 'research action:"plan" query:"<research request>"; returns visible-run, source, report, browser/fetch, and Knowledge routes without running them; use action:"runner" for browser-backed readiness only',
      ...
      webResearch: `multi-step: research action:"plan" query:"<research request>"; browser readiness: research action:"runner"; single-shot: ${has('web_search') ? 'web_search query:"<research request>" verbosity:"evidence" maxResults:10 evidenceTopN:3' : 'web_search not registered'}`,
