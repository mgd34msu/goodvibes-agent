  ...
  return {
    ...
    canDoNow: [
      ...
      },
      {
        ...
        inspect: 'research action:"plan" query:"<research request>"',
      },
      {
      ...
      },
      {
        ...
        tools: [optionalTool('vibe'), optionalTool('agent_harness'), optionalTool('agent_local_registry'), optionalTool('agent_learning_consolidation'), optionalTool('agent_work_plan'), optionalTool('agent_knowledge'), optionalTool('agent_knowledge_ingest')],
        inspect: 'vibe action:"status"; agent_harness mode:"prompt_context", mode:"memory_posture", or mode:"learning_curator"',
      },
      {
        ...
        tools: [optionalTool('personal_ops'), optionalTool('agent_harness'), optionalTool('agent_local_registry'), optionalTool('agent_work_plan'), optionalTool('schedule'), optionalTool('agent_autonomy_schedule'), optionalTool('agent_reminder_schedule'), optionalTool('agent_schedule_edit'), optionalTool('agent_channel_send')],
        inspect: 'personal_ops action:"intake" query:"<personal request>" or action:"status"',
      },
      {
      ...
      },
      {
        ...
        tools: [optionalTool('device'), optionalTool('agent_channel_send'), optionalTool('agent_notify'), optionalTool('schedule'), optionalTool('agent_autonomy_schedule'), optionalTool('agent_reminder_schedule'), optionalTool('agent_schedule_edit'), optionalTool('agent_media_generate')],
      ...
      },
      {
        ...
        tools: [optionalTool('device'), optionalTool('agent_harness'), optionalTool('setup')],
        inspect: 'device action:"status"; browser/PWA readiness with action:"browser"; browser/desktop control with action:"control"; voice posture with action:"voice"',
      },
      {
        ...
        tools: [optionalTool('models'), optionalTool('setup'), optionalTool('agent_harness'), optionalTool('import_goodvibes_settings')],
        inspect: 'setup action:"status"; use models action:"status|local|providers" for model/provider catalogs and agent_harness mode:"settings" for detailed settings',
      },
    ],
    ...
    commonRoutes: {
      ...
      researchWorkflow: 'research action:"plan" query:"<research request>"; returns visible-run, source, report, browser/fetch, and Knowledge routes without running them',
      ...
      researchReports: 'research action:"report" with reviewed sources, citation coverage repair metadata, optional requireCitationCoverage:true, confirm:true, and explicitUserRequest',
      ...
      webResearch: `multi-step: research action:"plan" query:"<research request>"; single-shot: ${has('web_search') ? 'web_search query:"<research request>" verbosity:"evidence" maxResults:10 evidenceTopN:3' : 'web_search not registered'}`,
