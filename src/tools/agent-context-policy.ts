  ...
  return {
    ...
    canDoNow: [
      ...
      },
      {
        ...
        can: 'Draft and revise documents in the main conversation, browse saved artifacts, promote reviewed artifacts into isolated Agent Knowledge, handle uploads, exports, source checks, generated media artifacts, and run confirmed blind model comparisons with durable review, judgment, and route-update actions.',
        tools: [optionalTool('agent_harness'), optionalTool('agent_artifacts'), optionalTool('agent_knowledge'), optionalTool('agent_knowledge_ingest'), optionalTool('agent_media_generate'), optionalTool('agent_model_compare')],
    ...
    commonRoutes: {
      ...
      artifacts: 'agent_artifacts mode:"list"; inspect with mode:"show"; promote reviewed artifact ids with agent_knowledge_ingest sourceKind:"artifact"',
