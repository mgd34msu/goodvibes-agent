...
function buildAgentCapabilitiesContract(registry?: ToolRegistry): Record<string, unknown> {
  ...
  return {
    ...
    commonRoutes: {
      ...
      documents: 'agent_documents mode:"list"; show with documentId; confirmed create/update/review/comment/resolveComment/suggest/acceptSuggestion/rejectSuggestion/insertArtifact/export with confirm:true',
