    ...
    canDoNow: [
      {
        ...
        tools: ['read', 'find', 'analyze', 'inspect', 'edit', 'write', 'exec', optionalTool('delegation')].filter(has),
        inspect: 'agent_harness mode:"execution_posture"; delegation action:"status"',
      },
      {
        area: 'Web research',
        can: has('web_search')
