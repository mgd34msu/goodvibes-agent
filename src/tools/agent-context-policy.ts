  ...
  return {
    ...
    canDoNow: [
      ...
      },
      {
        ...
        can: 'Use Agent-local memory, notes, personas, skills, routines, learning curator review/proposal queues, confirmed duplicate-consolidation phase helpers, work plans, and isolated Agent Knowledge ask/search/ingest routes.',
        tools: [optionalTool('agent_local_registry'), optionalTool('agent_learning_consolidation'), optionalTool('agent_work_plan'), optionalTool('agent_knowledge'), optionalTool('agent_knowledge_ingest')],
