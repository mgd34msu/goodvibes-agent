  ...
  return {
    ...
    canDoNow: [
      ...
      },
      {
        ...
        tools: [optionalTool('vibe'), optionalTool('context'), optionalTool('agent_harness'), optionalTool('agent_local_registry'), optionalTool('agent_learning_consolidation'), optionalTool('agent_work_plan'), optionalTool('agent_knowledge'), optionalTool('agent_knowledge_ingest')],
        inspect: 'vibe action:"status"; context action:"prompt|files"; agent_harness mode:"memory_posture" or mode:"learning_curator"',
      },
      {
      ...
      },
      {
        ...
        inspect: 'channels action:"status|triage|deliveries", agent_harness mode:"notifications", or mode:"autonomy_queue"',
      },
      {
