  ...
  return {
    ...
    canDoNow: [
      ...
      },
      {
        ...
        can: 'Use Agent-local memory, notes, personas, skills, routines, memory/vector posture, learning curator review/proposal queues, confirmed duplicate-consolidation phase helpers, work plans, and isolated Agent Knowledge ask/search/ingest routes.',
        ...
        inspect: 'agent_harness mode:"memory_posture" or mode:"learning_curator"',
      },
      {
      ...
      can: 'Create, revise, version, review, comment on, suggest changes to, attach or insert saved artifacts into, and export Agent document drafts with reviewer appendices; browse saved artifacts; track visible research run checkpoints; capture and review research source queues; save sourced research report artifacts; promote reviewed artifacts into isolated Agent Knowledge; handle uploads, source checks, generated media artifacts, and run confirmed blind model comparisons from prompts or saved text artifacts with durable review, side-by-side views, judgment, task/document/benchmark-filtered analytics/synthesis, reviewer handoff, handoff archive, and route-update actions.',
