  ...
  return {
    ...
    canDoNow: [
      ...
      },
      {
        ...
        can: 'Draft and revise documents in the main conversation, browse saved artifacts, handle uploads, exports, source checks, generated media artifacts, and run confirmed blind model comparisons with durable review, judgment, and route-update actions.',
    ...
    commonRoutes: {
      ...
      artifacts: 'agent_artifacts mode:"list"; inspect one saved artifact with mode:"show" artifactId:"<id>" includeContent:true',
