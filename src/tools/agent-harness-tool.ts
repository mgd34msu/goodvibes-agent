...
function detailedHarnessModelAccessGuide(): Record<string, string> {
  return {
    ...
    agentOrchestration: 'List mode:"agent_orchestration" for managed plan cards; dispatch approved plan items with agent_work_plan action:"dispatch_agents"; inspect mode:"agent_orchestration_agent"; spawn/message/wait/cancel stay on first-class agent.',
