...
function detailedHarnessModelAccessGuide(): Record<string, string> {
  return {
    ...
    agentOrchestration: 'List mode:"agent_orchestration" for managed plan cards; inspect mode:"agent_orchestration_agent"; spawn/message/wait/cancel stay on first-class agent.',
