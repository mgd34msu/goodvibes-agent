  ...
  return {
    definition: {
      ...
      description: [
        ...
        'This tool never creates, edits, deletes, or discovers automation definitions; never manages runtime hosting; never uses default Knowledge/Wiki, non-Agent knowledge segments, local workers, WRFC, or arbitrary route invocation.',
