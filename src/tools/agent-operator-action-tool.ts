  ...
  return {
    definition: {
      ...
      description: [
        ...
        'This tool never creates, edits, deletes, or discovers automation definitions; never manages connected-host hosting; never uses default knowledge, non-Agent knowledge segments, separate Agent jobs, WRFC, or arbitrary route invocation.',
