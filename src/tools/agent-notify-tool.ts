  ...
  return {
    definition: {
      ...
      description: [
        ...
        'This uses Agent-local notification webhook targets; it does not create channel routes, authorize accounts, manage connected-host hosting, create local workers, run WRFC, or write to default knowledge or non-Agent knowledge segments.',
