  ...
  return {
    definition: {
      ...
      description: [
        ...
        'This uses Agent-local notification webhook targets; it does not create channel routes, authorize accounts, start a daemon, spawn background agents, run WRFC, or write to default Knowledge/Wiki/HomeGraph.',
