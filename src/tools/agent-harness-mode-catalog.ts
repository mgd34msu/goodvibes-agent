...
export const HARNESS_MODE_DESCRIPTORS: readonly HarnessModeDescriptor[] = [
  ...
  { id: 'ui_surfaces', kind: 'discover', family: 'ui', summary: 'List modal, picker, and visible UI surfaces the model can request.', next: 'Use ui_surface or open_ui_surface.', keywords: ['web dashboard', 'pwa', 'browser cockpit', 'connected browser', 'mobile web'], parameters: ['query', 'limit', 'includeParameters'] },
  ...
  { id: 'channel_setup_guide', kind: 'inspect', family: 'delivery', summary: 'Inspect the ordered channel setup guide and current per-channel step.', parameters: ['channelId', 'target', 'query'] },
  { id: 'channel_triage', kind: 'discover', family: 'delivery', summary: 'Triage blockers, retries, messages, routes, and receipts.', keywords: ['inbox', 'triage', 'channel errors', 'delivery retries', 'pending messages', 'surface messages', 'route bindings'], parameters: ['limit', 'includeParameters'] },
  { id: 'channel_deliveries', kind: 'discover', family: 'delivery', summary: 'List recent redacted confirmed channel delivery receipts.', keywords: ['delivery receipts', 'channel history', 'sent messages', 'send outcomes'], parameters: ['limit', 'includeParameters'] },
  ...
  { id: 'project_context', kind: 'discover', family: 'context', summary: 'List AGENTS, HERMES, CLAUDE, SOUL, and Cursor context files.', next: 'Use project_context_file for one exact context file.', keywords: ['agents.md', 'hermes.md', '.hermes.md', 'claude.md', 'soul.md', '.cursorrules', '.cursor/rules', 'project instructions'], parameters: ['target', 'query', 'includeParameters'] },
  { id: 'project_context_file', kind: 'inspect', family: 'context', summary: 'Inspect one project context file body, source, or blocked reason.', keywords: ['agents.md', 'hermes.md', '.hermes.md', 'claude.md', 'soul.md', '.cursorrules', '.cursor/rules', 'project instructions'], parameters: ['contextFileId', 'target', 'query', 'includeParameters'] },
  { id: 'prompt_context', kind: 'inspect', family: 'context', summary: 'Inspect prompt context, receipt outcomes, and token budget.', keywords: ['prompt context', 'system prompt', 'why assistant acts', 'selected memory', 'active persona', 'suppressed context', 'token budget', 'receipt id', 'turn outcome', 'prompt receipt filters'], parameters: ['receiptId', 'turnId', 'outcomeStatus', 'limit', 'includeParameters'] },
  ...
  { id: 'model_routing', kind: 'discover', family: 'providers', summary: 'List model routes, readiness scores, local cookbook, and pins.', next: 'Use model_route or confirmed run_local_model_smoke.', parameters: ['query', 'limit', 'includeParameters'] },
  ...
  { id: 'execution_posture', kind: 'discover', family: 'execution', summary: 'Pick local shell/edit execution vs delegation.', next: 'Use execution_route.', keywords: ['sudo', 'sudo_password', 'SUDO_PASSWORD', 'foreground shell', 'privilege escalation'], parameters: ['query', 'limit', 'includeParameters'] },
  { id: 'execution_route', kind: 'inspect', family: 'execution', summary: 'Inspect one local, browser, web, or delegation route.', keywords: ['sudo', 'sudo_password', 'SUDO_PASSWORD', 'foreground shell', 'privilege escalation'], parameters: ['executionRouteId', 'target', 'query'] },
  { id: 'background_processes', kind: 'discover', family: 'execution', summary: 'List tracked local background processes, logs, and lifecycle routes.', next: 'Use background_process or run_background_process.', parameters: ['query', 'target', 'limit', 'includeParameters'] },
  { id: 'background_process', kind: 'inspect', family: 'execution', summary: 'Inspect one tracked background process with bounded output tails.', keywords: ['session id', 'process session', 'poll', 'log'], parameters: ['processId', 'processSessionId', 'sessionId', 'session_id', 'target', 'query', 'includeParameters'] },
  ...
  { id: 'execution_history', kind: 'discover', family: 'execution', summary: 'List recent execution activity cards and raw records.', next: 'Use execution_history_item.', parameters: ['query', 'limit', 'includeParameters'] },
  { id: 'execution_history_item', kind: 'inspect', family: 'execution', summary: 'Inspect one execution record with user card, routes, and recovery.', parameters: ['executionRecordId', 'recordId', 'target', 'query'] },
  ...
  { id: 'personal_ops_briefing', kind: 'discover', family: 'personal-ops', summary: 'Build a daily briefing plan across Personal Ops and autonomy.', next: 'Use lane routes, intake, or one confirmed read.', keywords: ['daily brief', 'morning brief', 'operator brief', 'personal briefing', 'daily ops', 'personal operations'], parameters: ['query', 'target', 'limit', 'includeParameters'] },
  { id: 'personal_ops', kind: 'discover', family: 'personal-ops', summary: 'Map email/calendar tasks, reminders, records, and operation cards.', next: 'Use personal_ops_briefing, personal_ops_intake, or inspect one lane.', keywords: ['personal operations'], parameters: ['includeParameters'] },
  { id: 'personal_ops_intake', kind: 'discover', family: 'personal-ops', summary: 'Plan personal requests to safe routes, fields, and confirmations.', next: 'Use the preferred route or inspect the returned lane.', keywords: ['personal operations', 'email calendar tasks reminders', 'email triage', 'inbox triage', 'draft reply', 'calendar briefing', 'agenda briefing', 'calendar conflicts', 'personal request', 'daily ops'], parameters: ['query', 'target', 'limit', 'includeParameters'] },
  ...
  { id: 'run_personal_ops_read', kind: 'effect', family: 'personal-ops', summary: 'Run one confirmed read-only inbox/calendar MCP operation.', requiresConfirmation: true, keywords: ['email triage', 'inbox read', 'calendar read', 'agenda read', 'mcp call tool'], parameters: ['laneId', 'recordId', 'target', 'query', 'fields', 'includeParameters', 'confirm', 'explicitUserRequest'] },
  ...
  { id: 'autonomy_intake', kind: 'discover', family: 'personal-ops', summary: 'Route ongoing work with schedule and watcher trigger posture.', next: 'Use returned route or autonomy_queue.', keywords: ['incoming webhook', 'webhook watcher', 'watcher trigger', 'event trigger', 'gmail trigger', 'cron wakeup'], parameters: ['query', 'target', 'includeParameters'] },
  ...
  { id: 'research_workflow', kind: 'discover', family: 'research', summary: 'Plan research routes across run, source, report, browser, Knowledge.', next: 'Use returned confirmed routes for each separate effect.', parameters: ['query', 'target', 'runId', 'includeParameters'] },
