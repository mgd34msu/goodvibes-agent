...
export const HARNESS_MODE_DESCRIPTORS: readonly HarnessModeDescriptor[] = [
  ...
  { id: 'background_process', kind: 'inspect', family: 'execution', summary: 'Inspect one tracked background process with bounded output tails.', parameters: ['processId', 'target', 'query', 'includeParameters'] },
  { id: 'run_background_process', kind: 'effect', family: 'execution', summary: 'Start/wait/stop background process; reports PTY/sudo gaps.', requiresConfirmation: true, parameters: ['processAction', 'processId', 'command', 'cwd', 'timeoutMs', 'pty', 'data', 'fields', 'confirm', 'explicitUserRequest'] },
