...
export const HARNESS_MODE_DESCRIPTORS: readonly HarnessModeDescriptor[] = [
  ...
  { id: 'autonomy_queue', kind: 'discover', family: 'personal-ops', summary: 'List visible autonomous work, owners, status, and cancel routes.', next: 'Use autonomy_queue_item.', parameters: ['query', 'limit', 'includeParameters'] },
  { id: 'autonomy_queue_item', kind: 'inspect', family: 'personal-ops', summary: 'Inspect one autonomy queue card and its owning visible routes.', parameters: ['queueItemId', 'target', 'query'] },
  { id: 'learning_curator', kind: 'discover', family: 'personal-ops', summary: 'Rank local memory, skill, routine, note, and persona review work.', next: 'Use learning_candidate.', parameters: ['query', 'limit', 'includeParameters'] },
  ...
  { id: 'research_runs', kind: 'discover', family: 'research', summary: 'List deep-research runs, phase, checkpoints, and controls.', next: 'Use research_run for one run.', parameters: ['query', 'limit', 'includeParameters'] },
  { id: 'research_run', kind: 'inspect', family: 'research', summary: 'Inspect one research run, checkpoint, resume, and cancel routes.', parameters: ['runId', 'target', 'query'] },
  { id: 'research_queue', kind: 'discover', family: 'research', summary: 'List research sources, credibility, citations, and next actions.', next: 'Use research_source for one source.', parameters: ['query', 'limit', 'includeParameters'] },
  { id: 'research_source', kind: 'inspect', family: 'research', summary: 'Inspect one source, report line, and review or ingest routes.', parameters: ['sourceId', 'target', 'query'] },
