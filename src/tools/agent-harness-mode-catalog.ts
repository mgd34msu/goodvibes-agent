...
export const HARNESS_MODE_DESCRIPTORS: readonly HarnessModeDescriptor[] = [
  ...
  { id: 'agent_orchestration', kind: 'discover', family: 'execution', summary: 'Inspect managed multi-agent plan cards, evidence, and routes.', next: 'Use agent_orchestration_agent for one visible agent.', keywords: ['subagent', 'subagents', 'agent spawn', 'batch-spawn', 'multi-agent', 'multi-runner', 'managed plan', 'milestone', 'remote runner', 'artifact trail', 'visible agents', 'cancellable agents', 'wrfc', 'cohort'], parameters: ['query', 'limit', 'includeParameters'] },
