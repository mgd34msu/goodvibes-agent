...
export const HARNESS_MODE_DESCRIPTORS: readonly HarnessModeDescriptor[] = [
  ...
  { id: 'research_workflow', kind: 'discover', family: 'research', summary: 'Plan research routes across run, source, report, browser, Knowledge.', next: 'Prefer research action:"plan"; use confirmed routes separately.', parameters: ['query', 'target', 'runId', 'includeParameters'] },
