...
export const HARNESS_MODE_DESCRIPTORS: readonly HarnessModeDescriptor[] = [
  ...
  { id: 'agent_orchestration', kind: 'discover', family: 'execution', summary: 'Inspect visible Agent spawn policy, routes, and live agents.', next: 'Use agent_orchestration_agent for one visible agent.', keywords: ['subagent', 'subagents', 'agent spawn', 'batch-spawn', 'multi-agent', 'visible agents', 'cancellable agents', 'wrfc', 'cohort'], parameters: ['query', 'limit', 'includeParameters'] },
  { id: 'agent_orchestration_agent', kind: 'inspect', family: 'execution', summary: 'Inspect one visible Agent record and safe control routes.', keywords: ['subagent', 'subagents', 'agent status', 'agent cancel', 'agent wait', 'agent message', 'batch-spawn', 'multi-agent', 'visible agents', 'cancellable agents', 'wrfc', 'cohort'], parameters: ['agentId', 'target', 'query', 'includeParameters'] },
