...
export const HARNESS_MODE_DESCRIPTORS: readonly HarnessModeDescriptor[] = [
  ...
  { id: 'prompt_context', kind: 'inspect', family: 'context', summary: 'Inspect applied prompt context, selected records, and token budget.', keywords: ['prompt context', 'system prompt', 'why assistant acts', 'selected memory', 'active persona', 'suppressed context', 'token budget'], parameters: ['includeParameters'] },
