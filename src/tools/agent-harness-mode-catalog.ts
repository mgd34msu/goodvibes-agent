...
export const HARNESS_MODE_DESCRIPTORS: readonly HarnessModeDescriptor[] = [
  ...
  { id: 'document_ops', kind: 'discover', family: 'documents', summary: 'Map documents, uploads, reviewer checks, and blind model comparison.', next: 'Use document_ops_lane for readiness, sources, artifacts, compare.', parameters: ['includeParameters'] },
  { id: 'document_ops_lane', kind: 'inspect', family: 'documents', summary: 'Inspect document uploads, artifacts, readiness, and blind model compare.', parameters: ['laneId', 'target', 'query'] },
