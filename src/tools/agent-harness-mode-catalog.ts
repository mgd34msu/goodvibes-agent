...
export const HARNESS_MODE_DESCRIPTORS: readonly HarnessModeDescriptor[] = [
  ...
  { id: 'agent_orchestration', kind: 'discover', family: 'execution', summary: 'Inspect managed multi-agent cards, evidence, and dispatch routes.', next: 'Inspect one agent; dispatch approved plan items via agent_work_plan.', keywords: ['subagent', 'subagents', 'agent spawn', 'batch-spawn', 'dispatch agents', 'work plan dispatch', 'multi-agent', 'multi-runner', 'managed plan', 'milestone', 'remote runner', 'artifact trail', 'visible agents', 'cancellable agents', 'wrfc', 'cohort'], parameters: ['query', 'limit', 'includeParameters'] },
  { id: 'agent_orchestration_agent', kind: 'inspect', family: 'execution', summary: 'Inspect one visible Agent record with plan card and safe controls.', keywords: ['subagent', 'subagents', 'agent status', 'agent cancel', 'agent wait', 'agent message', 'batch-spawn', 'multi-agent', 'multi-runner', 'managed plan', 'milestone', 'remote runner', 'artifact trail', 'visible agents', 'cancellable agents', 'wrfc', 'cohort'], parameters: ['agentId', 'target', 'query', 'includeParameters'] },
  ...
  { id: 'personal_ops', kind: 'discover', family: 'personal-ops', summary: 'Map email/calendar tasks, reminders, records, and operation cards.', next: 'Use personal_ops_intake or inspect one lane.', keywords: ['personal operations'], parameters: ['includeParameters'] },
