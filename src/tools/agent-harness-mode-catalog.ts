...
export const HARNESS_MODE_DESCRIPTORS: readonly HarnessModeDescriptor[] = [
  ...
  { id: 'run_setup_smoke', kind: 'effect', family: 'setup', summary: 'Run redacted first-run setup smoke evidence collection.', requiresConfirmation: true, parameters: ['setupItemId', 'includeParameters', 'confirm', 'explicitUserRequest'] },
