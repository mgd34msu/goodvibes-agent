...
function promptContextSegments(context: CommandContext, includeParameters: boolean): readonly PromptContextSegment[] {
  ...
  return [
    ...
    segment({
      ...
      route: 'agent_harness mode:"run_command" commandName:"vibe" args:["status"] confirm:true explicitUserRequest:"Inspect VIBE.md personality status."',
...
export function promptContextSummary(context: CommandContext, args: PromptContextArgs): Record<string, unknown> {
  ...
  return {
    ...
    routes: {
      ...
      vibeStatus: 'agent_harness mode:"run_command" commandName:"vibe" args:["status"] confirm:true explicitUserRequest:"Inspect VIBE.md personality status."',
