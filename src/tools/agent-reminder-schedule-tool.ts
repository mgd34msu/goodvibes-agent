  ...
  return {
    definition: {
      ...
      description: [
        ...
        'This calls the public schedules.create route on the connected GoodVibes host; it does not start a daemon, create a local scheduler, spawn background agents, use WRFC, or write to default Knowledge/Wiki/HomeGraph.',
