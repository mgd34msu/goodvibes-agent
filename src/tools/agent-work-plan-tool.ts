  ...
  return {
    definition: {
      ...
      description: [
        ...
        'This uses only Agent-local persisted work-plan state; it does not call connected-host mutation routes, start local jobs, create local workers, use WRFC, write default Knowledge/Wiki, or use non-Agent knowledge segments.',
