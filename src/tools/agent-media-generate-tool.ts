  ...
  return {
    definition: {
      ...
      description: [
        ...
        'This tool does not use default Knowledge/Wiki, non-Agent knowledge segments, connected-host lifecycle routes, local workers, WRFC, channel sends, or arbitrary route invocation.',
