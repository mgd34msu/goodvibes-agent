...
function describeRepairDecision(decision: SetupRepairDecision, includeParameters: boolean): Record<string, unknown> {
  return {
    id: decision.id,
...
function setupRepairDecisionFromCard(
...
function setupRepairDecisionFromHandoff(
...
function repairCardById(item: SetupPlanItem, id: string): SetupRepairCard | null {
  return item.repairCards?.find((card) => card.id === id) ?? null;
}

function confirmedRepairCandidates(item: SetupPlanItem): readonly SetupRepairDecision[] {
...
function primarySetupRepairDecision(item: SetupPlanItem): SetupRepairDecision {
...
function setupRepairPlanCandidates(plan: readonly SetupPlanItem[], input: string): readonly SetupPlanItem[] {
...
function defaultSetupRepairItem(plan: readonly SetupPlanItem[], wizard: AgentSetupWizard): SetupPlanItem | null {
