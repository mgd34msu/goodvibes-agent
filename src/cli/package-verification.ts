...
function verifyPublishPackageScriptPolicy(root: string): readonly string[] {
  ...
  const requiredMarkers: readonly { readonly marker: string; readonly label: string }[] = [
    ...
    { marker: 'assertPackagePolicy(root, \'source package\')', label: 'source package policy check' },
    ...
    { marker: 'assertPackagePolicy(stageDir, \'staged package\')', label: 'staged package policy check' },
