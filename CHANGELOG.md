...
- Added `computer action:"plan"` and `agent_harness mode:"browser_control_route"` for read-only browser navigation, screenshot, and desktop-control workflow routing.
