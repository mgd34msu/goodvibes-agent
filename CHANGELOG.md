...
- Routed support-bundle, saved-session/bookmark, and release/audit evidence wording through `agent_harness mode:"support_bundles|sessions|release_readiness|release_evidence"` before export/import/share, session lifecycle, or audit drill-in effects.
