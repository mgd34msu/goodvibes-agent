...
- `agent_documents` and `agent_artifacts` for versioned Agent document drafts, review comments, saved artifact insertion, markdown artifact export, saved artifact browsing, and reviewed artifact-to-Knowledge promotion.
