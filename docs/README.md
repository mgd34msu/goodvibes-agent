...
- `agent_documents`, `agent_artifacts`, `agent_research_sources`, and `agent_research_report` for versioned Agent document drafts, review comments, AI suggestion review, saved artifact attachment/insertion, markdown artifact export, saved artifact browsing/export/package, project-local research source review, sourced research report artifacts, and reviewed artifact-to-Knowledge promotion.
