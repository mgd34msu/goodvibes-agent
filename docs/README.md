...
- `agent_channel_send`, `agent_notify`, `agent_autonomy_schedule`, `agent_reminder_schedule`, `agent_media_generate`, and `agent_model_compare` for explicit confirmed effects, including connected autonomous schedules and blind comparison from saved text artifacts.
