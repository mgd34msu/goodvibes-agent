...
- `agent_documents` and `agent_artifacts` for versioned Agent document drafts, markdown artifact export, saved artifact browsing, and reviewed artifact-to-Knowledge promotion.
