...
- `agent_documents` and `agent_artifacts` for versioned Agent document drafts, review comments, AI suggestion review, saved artifact attachment/insertion, markdown artifact export, saved artifact browsing, and reviewed artifact-to-Knowledge promotion.
