...
- Browser/desktop-control setup and recovery beyond the current local-first execution posture for read/edit/exec, web fetch, supervision routes, confirmed file edit recovery, and delegation routing.
