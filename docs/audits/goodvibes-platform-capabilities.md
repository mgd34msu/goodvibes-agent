...
- Learning curator now ranks local review/setup/stale candidates, reviewed-note behavior proposals, and visible completed-work proposals; session/research completion capture and consolidation still need depth.
