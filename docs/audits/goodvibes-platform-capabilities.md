...
- Learning curator now ranks local review/setup/stale candidates, reviewed-note memory/behavior proposals, visible completed-work memory/behavior proposals, and completed-research memory/behavior proposals; session-level capture and consolidation still need depth.
