...
- Richer attach/export artifact reuse actions on top of versioned Agent document drafts, review comments, AI suggestion review, artifact-to-document insertion, and artifact-to-compare reuse.
