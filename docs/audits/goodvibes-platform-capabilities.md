...
- Learning curator now ranks local review/setup/stale candidates, reviewed-note memory/behavior proposals, visible completed-work memory/behavior proposals, completed-research memory/behavior proposals, and saved-session memory/behavior proposals; consolidation still needs depth.
