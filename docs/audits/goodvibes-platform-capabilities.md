...
- Learning curator now ranks local review/setup/stale candidates, reviewed-note memory/behavior proposals, and visible completed-work memory/behavior proposals; session/research completion capture and consolidation still need depth.
