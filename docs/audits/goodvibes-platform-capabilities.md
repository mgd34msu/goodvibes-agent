...
- `agent_harness mode:"summary"` now starts with an assistant-first cockpit for setup, chat/model, project work, Personal Ops, research/docs, background work, and safety/recovery, while host/daemon/provider/MCP/delegation details stay in diagnostics and confirmation boundaries.
