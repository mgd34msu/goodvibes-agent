...
- Deep research live cancellation, checkpoint/resume, and richer report runner state beyond the current source queue, credibility scoring, and saved sourced report artifacts.
