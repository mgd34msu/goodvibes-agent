...
- AI suggestion review and richer attach/export/compare artifact reuse actions on top of versioned Agent document drafts, review comments, and artifact-to-document insertion.
