...
- Live local model benchmark execution beyond the current read-only readiness scoring, hardware-scored cookbook, setup/download guidance, provider-refresh routes, and benchmark prompts.
