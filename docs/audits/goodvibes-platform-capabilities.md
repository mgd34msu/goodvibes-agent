...
- Deep research browser-backed execution, run log tails, citation coverage checks, and richer report runner output beyond the current visible local run ledger, source queue, credibility scoring, and saved sourced report artifacts.
