...
- Deep research browser-backed execution, run log tails, and richer report runner output beyond the current visible local run ledger, source queue, credibility scoring, source bundles, citation coverage metadata, repair hints, and saved sourced report artifacts.
