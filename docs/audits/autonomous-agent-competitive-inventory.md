...
| Documents and model comparison | Canvas/web primitives | TUI/dashboard/session tools | Documents and blind Compare | Partial: Document Ops has project-scoped versioned markdown drafts with browse/show/create/revise/review/comment/suggest/accept-suggestion/reject-suggestion/artifact-insert/export, unified artifact browse/show plus confirmed artifact-to-Knowledge promotion and artifact-to-compare reuse for saved text artifacts, and a confirmed blind runner with durable JSON artifacts, saved review boards, saved judgments, saved preference analytics, markdown report export, and confirmed route updates; richer attach/export reuse actions remain unfinished | Parity |
...
4. Email, calendar, richer attach/export artifact reuse actions, deep research reports, local model serving recommendations, and browser/computer-use setup are the clearest product gaps.
...
- Promote Document Ops from versioned drafts, review comments, AI suggestion review, and artifact-to-compare reuse into richer attach/export actions on top of the artifact browser, artifact insertion, and Knowledge promotion routes.
