...
| Documents and model comparison | Canvas/web primitives | TUI/dashboard/session tools | Documents and blind Compare | Gap: no document editor or comparison surface | Parity |
...
4. Email, calendar, document editing, blind model comparison, deep research reports, local model serving recommendations, and browser/computer-use setup are the clearest product gaps.
