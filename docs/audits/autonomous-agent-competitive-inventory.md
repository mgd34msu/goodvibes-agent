...
- Turn research from the current visible run ledger into a browser-backed live report workflow with coverage-guided repair, artifacts, cancellation, and explicit knowledge ingest.
