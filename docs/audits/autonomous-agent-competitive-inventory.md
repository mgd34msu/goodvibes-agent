...
4. Email, calendar, dedicated document editing, model-comparison route handoff/analytics, deep research reports, local model serving recommendations, and browser/computer-use setup are the clearest product gaps.
...
- Promote Document Ops from readiness map into a real document editor, versioned artifact browser, comparison analytics/export, and route-update handoff.
