...
4. Email, calendar, browser-backed deep research runners, hardware-scored local model serving, and first-class browser/desktop-control adapters are the clearest product gaps.
