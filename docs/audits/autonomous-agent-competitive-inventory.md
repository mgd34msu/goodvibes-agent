...
4. Email, calendar, dedicated document editing, visual model-comparison review, deep research reports, local model serving recommendations, and browser/computer-use setup are the clearest product gaps.
...
- Promote Document Ops from readiness map into a real document editor, versioned artifact browser, visual comparison review, saved preferences, and route-update handoff.
