...
4. Email, calendar, dedicated document editing, model-comparison analytics/export, deep research reports, local model serving recommendations, and browser/computer-use setup are the clearest product gaps.
...
- Promote Document Ops from readiness map into a real document editor, versioned artifact browser, and comparison analytics/export.
