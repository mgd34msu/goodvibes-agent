...
| Documents and model comparison | Canvas/web primitives | TUI/dashboard/session tools | Documents and blind Compare | Partial: Document Ops maps uploads/export/artifacts/sources and has a confirmed blind runner; no dedicated editor, saved comparison review, or unified artifact browser | Parity |
...
4. Email, calendar, dedicated document editing, saved model-comparison review, deep research reports, local model serving recommendations, and browser/computer-use setup are the clearest product gaps.
...
- Promote Document Ops from readiness map into a real document editor, versioned artifact browser, saved comparison review, and route-update handoff.
