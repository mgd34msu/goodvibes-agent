...
| Closed learning loop | Skills and memory | Autonomous memory, skills, session search, user model | Persistent vector/keyword memory and skills | Partial: local libraries and read-only curator with reviewed-note and completed-work proposals exist; session/research completion capture and consolidation still need depth | Better |
