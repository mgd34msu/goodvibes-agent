...
| Documents and model comparison | Canvas/web primitives | TUI/dashboard/session tools | Documents and blind Compare | Partial: Document Ops maps uploads/export/artifacts/sources and compare gap; no dedicated editor or blind runner | Parity |
...
4. Email, calendar, dedicated document editing, blind model comparison runner, deep research reports, local model serving recommendations, and browser/computer-use setup are the clearest product gaps.
...
- Promote Document Ops from readiness map into a real document editor, versioned artifact browser, and blind model comparison runner.
