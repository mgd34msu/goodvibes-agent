...
| Email, calendar, notes, tasks | Mail/calendar/reminder workflows in showcase | Email gateway and workspace skills | IMAP/SMTP triage, CalDAV, notes/tasks | Partial: Personal Ops has live note/routine/delivery records and MCP connector setup routes; inbox/agenda workflows still need connector-backed wrapping | Better |
...
- Build first-class email/calendar triage and agenda workflows on top of connector-backed tools, then extend Personal Ops live records into inbox, agenda, task, and reminder queues.
