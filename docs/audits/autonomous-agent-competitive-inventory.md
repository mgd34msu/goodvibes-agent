...
4. Email, calendar, dedicated document editing, deep research reports, local model serving recommendations, unified artifact browsing, and browser/computer-use setup are the clearest product gaps.
...
- Promote Document Ops from readiness map into a real document editor and versioned artifact browser.
