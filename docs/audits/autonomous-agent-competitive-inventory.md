...
| Documents and model comparison | Canvas/web primitives | TUI/dashboard/session tools | Documents and blind Compare | Partial: Document Ops has project-scoped versioned markdown drafts with browse/show/create/revise/review/export, unified artifact browse/show plus confirmed artifact-to-Knowledge promotion, and a confirmed blind runner with durable JSON artifacts, saved review boards, saved judgments, saved preference analytics, markdown report export, and confirmed route updates; comments, AI suggestion review, and richer insert/attach/export reuse actions remain unfinished | Parity |
...
4. Email, calendar, document comments and AI suggestion review, richer artifact reuse actions, deep research reports, local model serving recommendations, and browser/computer-use setup are the clearest product gaps.
...
- Promote Document Ops from versioned drafts into collaborative document review with comments, AI suggestion review, and richer insert/attach/export actions on top of the artifact browser and Knowledge promotion route.
