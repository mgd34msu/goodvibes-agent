...
- Local Context -> Inspect VIBE.md, Inspect project context, or Inspect one context file before relying on persistent personality or project instructions.
