...
- Research: read-only web research and URL inspection, project-local visible research runs, source queue and credibility review, plus confirmed sourced markdown report artifacts with source maps and citation coverage checks.
