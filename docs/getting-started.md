...
- Channels: companion pairing, an ordered channel setup guide, channel readiness, notification targets, allowlist/status review, redacted confirmed-send receipts, and confirmed sends.
...
| Channels, notifications, reminders, scheduled autonomy, media | `agent_channel_send`, `agent_harness mode:"channel_deliveries"`, `agent_notify`, `agent_reminder_schedule`, `agent_autonomy_schedule`, `agent_schedule_edit`, `agent_media_generate` |
