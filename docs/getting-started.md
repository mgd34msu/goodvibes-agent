...
- Research: read-only web research and URL inspection, project-local source queue and credibility review, plus confirmed sourced markdown report artifacts with source maps.
...
| Research sources and reports | `agent_harness mode:"research_queue"`, `agent_research_sources`, `agent_research_report` |
