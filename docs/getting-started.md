...
- Memory & Skills: local memory, notes, personas, skills, routines, learned behavior capture, and a read-only learning curator for review/setup/stale/reviewed-note/completed-work behavior candidates.
...
- Memory & Skills -> Learning curator to rank stale, low-confidence, missing-setup, reviewed-note behavior proposals, completed-work behavior proposals, and review-needed local behavior records before they silently guide the assistant.
