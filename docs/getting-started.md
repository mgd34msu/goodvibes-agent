...
| VIBE.md, project context, and local memory/notes/personas/skills/routines | `vibe action:"status|show|init|import_persona"`, `/vibe`, `context action:"status|files|file|prompt|receipts|receipt"`, `agent_local_registry`, `agent_learning_consolidation`, or confirmed workspace actions |
