...
| Channels, notifications, reminders, scheduled autonomy, media | `agent_channel_send`, `agent_notify`, `agent_reminder_schedule`, `agent_autonomy_schedule`, `agent_media_generate` |
