...
| VIBE.md, project context, and local memory/notes/personas/skills/routines | `vibe action:"status|show|init|import_persona"`, `/vibe`, `agent_harness mode:"prompt_context"`, `mode:"project_context"`, `mode:"project_context_file"`, `agent_local_registry`, `agent_learning_consolidation`, or confirmed workspace actions |
