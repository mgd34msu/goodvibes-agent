...
| Visible UI | `agent_harness mode:"panels"`, `mode:"ui_surfaces"`, `mode:"open_panel"`, `mode:"open_ui_surface"`; browser cockpit uses `surfaceId:"connected-browser-cockpit"` |
