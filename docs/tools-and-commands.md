...
| `prompt_context` | Applied prompt composition order, selected context records, suppressed records, prompt previews on request, and approximate token budget. |
