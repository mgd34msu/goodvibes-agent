...
| `agent_documents` | Create, revise, review, list, show, and export project-scoped versioned Agent document drafts. |
...
- Agent document draft browse/show/create/revise/review/export dispatches through `agent_documents`.
