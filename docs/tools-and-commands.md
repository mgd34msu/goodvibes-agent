...
| `agent_model_compare` | Run, review, side-by-side view, judge, analytics/synthesis, apply, export, handoff, or reveal one blind model comparison, optionally from a saved text artifact. |
