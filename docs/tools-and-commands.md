...
| `prompt_context` | Applied prompt composition order, recent durable receipt ids, selected context records, suppressed records, prompt previews on request, and approximate token budget. |
