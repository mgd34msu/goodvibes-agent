...
| `personal_ops`, `personal_ops_lane` | Inbox/calendar connector readiness, triage/draft/agenda/conflict workflow cards, matching MCP setup routes, and live Agent-owned note, routine, schedule-receipt, and delivery records. |
