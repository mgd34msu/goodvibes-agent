...
| `autonomy_intake`, `autonomy_queue`, `autonomy_queue_item` | Ongoing-work route selection, visible autonomous work owners, status, live records, log tails, task/run diagnostics, inspect routes, and normalized checkpoint/pause/resume/cancel/recovery controls. |
