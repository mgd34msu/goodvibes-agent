...
| `browser` | Drive a real web browser: open pages, take an element snapshot, click, type, select, scroll, wait, read the page text, screenshot, manage tabs, and evaluate script in the page. Provisions its own browser on first use and keeps sign-ins in a saved profile. |
