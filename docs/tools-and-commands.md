...
| `mcp_servers`, `setup_posture`, `pairing_posture`, `delegation_posture` | MCP, first-run setup plan with probe-fed connected-host repair cards and local model readiness, pairing, and build-delegation posture. |
