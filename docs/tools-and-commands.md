...
| `agent_review_packet_presets` | Save, list, show, and freshness-check reusable Document Ops review packet presets without changing drafts, routes, handoffs, or archives. |
