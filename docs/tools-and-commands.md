...
| `document_ops`, `document_ops_lane` | Documents, review packet timeline, reviewer-readiness checks, uploads, exports, sources, artifact browse/promotion, media artifacts, and blind model comparison. |
